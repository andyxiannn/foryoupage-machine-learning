...
class ModelEvaluator:
    def __init__(self, interactions_full_indexed_df, interactions_test_indexed_df, interactions_train_indexed_df, articles_df, items_df=None):
    ...
    def get_not_interacted_items_sample(self, person_id, sample_size, seed=42):
        ...
        #if non-interacted-items too less then set it same as sample size
